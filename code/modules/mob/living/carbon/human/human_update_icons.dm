...
/mob/living/carbon/human/update_worn_undersuit()
	...
	if(istype(w_uniform, /obj/item/clothing/under))
		...
		//found_special_sprite/autogen_override is used to track whether or not we successfully used an alternate sprite.
		//icon_file MUST be set to null by default, or it causes issues.
		//"override_file = (found_special_sprite || autogen_override) ? icon_file : null" MUST be added to the arguments of build_worn_icon()
		...
		uniform_overlay = uniform.build_worn_icon(
			...
			override_file = (found_special_sprite || autogen_override) ? icon_file : null,
